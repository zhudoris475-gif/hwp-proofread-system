...
CONTEXT_SPACING_RULES = [
    ...
    (r'말한대로', '말한 대로'),
    (r'약속한대로', '약속한 대로'),
    (r'(\d+)(명|개|원|건|곳|마리|권|장)이상', r'\1\2 이상'),
    (r'(\d+)(명|개|원|건|곳|마리|권|장)이하', r'\1\2 이하'),
    (r'(\w+)가운데', r'\1 가운데'),
    (r'(\w+)밖에', r'\1 밖에'),
    (r'(\w+)밖으로', r'\1 밖으로'),
