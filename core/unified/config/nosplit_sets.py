# -*- coding: utf-8 -*-
# NOSPLIT exception sets for Korean dependency noun spacing rules
# Synchronized from fix_context_aware.py
# Total: 35+ categories

GEOT_NOSPLIT = {
    "이것", "그것", "저것", "이것저것", "그것저것", "보잘것", "옛것", "새것", "별것",
    "모든것", "어느것", "어떤것", "들것", "말것",
...
SAI_NOSPLIT = {"강사이", "수사이", "두사이", "그사이", "이사이", "중간사이", "일사이", "제사이", "사이사이", "사이버", "갈비대사이"}
...
DE_NOSPLIT = {"가운데", "한가운데", "그가운데", "포름알데", "놀포름알데",
