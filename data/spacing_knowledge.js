...
const spacingData = [
  {
    ...
    "output": "15) 장소를 나타내는 고유명사와 관련한 띄여쓰기\n\n올바름: 학교 가다\n그릇됨: 학교가다\n\n설명: 품사의 성격과 결합 관계에 따라 띄여쓰기 또는 붙여쓰기를 결정한다.",
    "metadata": {
      "category": "spacing",
      "type": "general_rule",
      "examples": [
  ...
  {
    "instruction": "방위를 나타내는 단어(우, 아래, 밑, 옆, 안, 밖, 속, 사이, 끝, 가운테, 어간, 때 등)와 시간을 나타내는 단어(해, 달, 날, 곳, 어구, 구석, 다음, 동안, 중순, 동쪽 등)의 띄여쓰기 규칙을 설명하라.",
    "output": "방위를 나타내는 단어와 시간을 나타내는 단어는 앞의 단어와 띄여써야 한다.\n\n해당 단어들:\n- 방위: 우, 아래, 밑, 결, 옆, 안, 밖, 속, 사이(재), 끝, 가운테, 어간, 때...\n- 시간/장소: 해, 달, 날, 곳, 어구, 구석, 다음, 동안, 중순, 동쪽...\n\n례:\n올바름: 인민 앞, 교실 옆, 하늘 아래, 후리 가운테, 마을 어구, 냐음 해, 어느 해, 어느 때, 여느 해, 여느 때...\n그릇됨: 인민앞, 교실옆, 하늘아래, 후리가욱테, 마을어구, 냐음해, 어느해, 어느때, 여느해, 여느때...\n\n설명: 이들은 독립적인 의미를 가진 명사로, 앞의 단어와 문법적 결합이 약하므로 띄여쓴다.",
    "input": "",
    "metadata": {
      "category": "spacing",
      "type": "directional_words",
      "has_examples": true,
      "enhanced": true,
      "source": "user_added"
    }
  ...
  {
    "instruction": "앞/뒤가 체언의 앞에 올 때 붙여쓰기와 띄여쓰기의 구분 규칙을 설명하라.",
    "output": "앞/뒤가 체언의 앞에 올 때, 의미적 통합성에 따라 붙여쓰기와 띄여쓰기를 구분한다.\n\n1) 하나의 뜻덩이로 묶어지는 경우 → 붙여쓰기\n   - 앞단어 (前词, 전문용어)\n   - 뒤단어 (后词, 전문용어)  \n   - 앞짐자동차 (前吉普车, 전문용어)\n   - 뒤련합부 (后联合部, 전문용어)\n\n2) 하나의 뜻덩이로 묶어지지 않는 경우 → 띄여쓰기\n   - 앞 단어(앞에 있는 단어)\n   - 뒤 단어(뒤에 있는 단어)\n   - 앞 짐자동차(앞에 있는 짐자동차)\n   - 뒤 련합부(뒤에 있는 련합부)\n\n례:\n올바름: 앞단어 (전문용어), 앞 단어 (수식관계)\n그릇됨: 앞 단어 (전문용어로 쓸 때), 앞단어 (수식관계로 쓸 때)\n\n설명: \n- '앞단어'는 '前词'라는 하나의 개념(전문용어)\n- '앞 단어'는 '앞에 있는' + '단어'라는 수식관계\n- 의미적 통합성이 있는지 판단하여 구분한다.",
    "input": "",
    "metadata": {
      "category": "spacing",
      "type": "ap_dwi_prefix",
  ...
  {
    "instruction": "앞/뒤의 의미적 통합성 판단 기준을 설명하라.",
    "output": "앞/뒤가 체언과 결합할 때 의미적 통합성 판단 기준:\n\n1. 전문용어/고유명사 여부\n   - 앞단어 = '前词'라는 전문용어 → 붙여쓰기\n   - 앞 짐자동차 = '앞에 있는 짐자동차' → 띄여쓰기\n\n2. 수식관계 vs 통합관계\n   - 수식관계: [앞] + [짐자동차] = 띄여쓰기\n   - 통합관계: [앞+짐자동차] = 붙여쓰기\n\n3. 대체 가능성 테스트\n   - '앞'을 '전(前)'으로 바꿔도 의미가 통하면 붙여쓰기\n   - '앞 짐자동차' → '전 짐자동차' (어색) → 띄여쓰기\n   - '앞단어' → '전단어' (가능) → 붙여쓰기\n\n례:\n올바름: \n- 앞단어 (전문용어)\n- 앞 짐자동차 (수식관계)\n- 뒤련합부 (전문용어)\n- 뒤 련합부 (수식관계)\n\n그릇됨:\n- 앞 단어 (전문용어로 쓸 때)\n- 앞짐자동차 (수식관계로 쓸 때)\n\n설명: 의미적 통합성은 해당 결합이 하나의 고정된 개념을 형성하는지 여부로 판단한다.",
    "input": "",
    "metadata": {
      "category": "spacing",
  ...
  {
    "instruction": "다음 띄여쓰기 예시를 설명하라.",
    "output": "‘ㅎ’이  약화되거나 탈락되는 것은 모두 모음 사이거나유향음과 모음 사이인 것이다. 모음과 유향음은 모두 성문에서 목청을 울리는 소리이고‘ㅎ’은 성문을 마찰하는 소리로서 모두가 성문에서 소리가 이루어진다는 데 그 원인이  있다.  이런 음들은 런이어  발음할 때, 특히‘ㅎ’은 준비있게  발음하지  않으면(준비있게  발음하는 단어의  첫머리의‘ㅎ’은 똑똑히 발음한다.  례: 회의) 성문의 울림소리에압도되여  발음하지  않거나 약화된다.",
    "input": "",
    "metadata": {
      "category": "spacing",
      "type": "numeral",
  ...
  {
    "instruction": "불완전명사(의존 명사)의 띄여쓰기 규칙을 설명하라.",
    "output": "불완전명사(의존 명사)는 앞의 단어와 띄여써야 한다.\n\n정의:\n불완전명사란 문장구조 속에서 다른 단어에 의존하지 않고서는 홀로 자립적으로 쓰일 수 없는 명사를 가리킨다. 불완전명사는 다른 어떤 표식의 보충을 받지 않고서는 어떤 대상에 대하여 이름을 지어준다고 보기 어려울 정도로 대상적 의미가 불완전하나 명사의 하위분류로서 하나의 단어로 인식되기에 앞의 단어와 띄여써야 한다.\n\n규칙:\n[수식어] + [불완전명사] = 띄여쓰기\n\n주요 불완전명사:\n- 것: 좋은 것, 하는 것\n- 김: 시작한 김에, 나가는 김에\n- 나름: 사람 나름, 때 나름\n- 나위: 말할 나위, 할 나위\n- 노릇: 주인 노릇, 어른 노릇\n- 듯: 갈 듯, 올 듯\n- 만: 부를 만, 먹을 만\n- 대로: 하는 대로, 뛰는 대로\n- 데: 있는 데, 없는 데\n- 등: 사과 등, 책 등\n- 물: 한 물, 두 물\n- 물: 한 물, 두 물\n- 물: 한 물, 두 물\n- 별: 4촌 별, 6촌 별\n- 번: 놓칠 번, 까먹을 번\n- 바: 느낀 바, 알게 된 바\n- 리: 늦을 리, 그럴 리\n- 만치: 요구하는 만치, 하는 만치\n- 만큼: 먹을 만큼, 볼 만큼\n- 물: 한 물, 두 물\n- 물: 한 물, 두 물\n- 물: 한 물, 두 물\n- 물: 한 물, 두 물\n- 물: 한 물, 두 물\n- 물: 한 물, 두 물\n- 물: 한 물, 두 물\n- 물: 한 물, 두 물\n- 물: 한 물, 두 물\n- 물: 한 물, 두 물\n- 물: 한 물, 두 물\n- 물: 한 물, 두 물\n- 물: 한 물, 두 물\n- 물: 한 물, 두 물\n- 물: 한 물, 두 물\n- 물: 한 물, 두 물\n- 물: 한 물, 두 물\n- 물: 한 물, 두 물\n- 물: 한 물, 두 물\n\n례:\n올바름:\n- 좋은 것으로 고르시오.\n- 제도 개나 쓰던 놈.\n- 시작한 김에 일을 끝내다.\n- 잘 먹고 못 먹고는 사람 나름이다.\n- 말할 나위가 없다.\n- 점심 먹을 나절이라 장사군과 장군들로 붐볐다.\n- 해가 뜰 녘에 집을 떠났다.\n- 주인 노릇을 잘하시오.\n- 갈 듯도 하다.\n- 사과, 배, 복숭아 등 과일.\n- 바람 부는 대로 항라.\n- 노래 부르는 데 소절이 있다.\n- 그가 늦을 리 없다.\n- 노래를 부를 만하다.\n- 요구하는 만치 일을 맡기다.\n- 볼 만큼 보았다.\n- 식사를 끝낼 물력에 물이 상당히 빠져있었다.\n- 한 물밖에 안 입은 옷, 세 물째 딴 수박.\n- 느낀 바를 얘기하다.\n- 놓칠 번하다.\n- 4촌 별이 되는 사람.\n\n그릇됨:\n- 좋은것으로 고르시오.\n- 제도개나 쓰던 놈.\n- 시작한김에 일을 끝내다.\n- 잘 먹고 못 먹고는 사람나름이다.\n- 말할나위가 없다.\n- 점심 먹을나절이라 장사군과 장군들로 붐볐다.\n- 해가 뜰녘에 집을 떠났다.\n- 주인노릇을 잘하시오.\n- 갈듯도 하다.\n- 사과, 배, 복숭아등 과일.\n- 바람 부는대로 항라.\n- 노래 부르는데 소절이 있다.\n- 그가 늦을리 없다.\n- 노래를 부를만하다.\n- 요구하는만치 일을 맡기다.\n- 볼만큼 보았다.\n- 식사를 끝낼묘력에 물이 상당히 빠져있었다.\n- 한물밖에 안 입은 옷, 세물째 딴 수박.\n- 느낀바를 얘기하다.\n- 놓칠번하다.\n- 4촌별이 되는 사람.\n\n설명: 불완전명사는 명사의 하위분류로서 하나의 단어로 인식되지만, 앞의 수식어와는 띄여쓴다.",
    "input": "",
    "metadata": {
      "category": "spacing",
      "type": "incomplete_noun",
      "has_examples": true,
      "enhanced": true,
      "source": "user_added"
    }
  ...
  {
    "instruction": "불완전명사와 일반 명사의 구분 및 띄여쓰기 차이를 설명하라.",
    "output": "불완전명사와 일반 명사의 구분 및 띄여쓰기:\n\n1. 불완전명사 (의존 명사)\n   - 정의: 홀로 자립적으로 쓰일 수 없는 명사\n   - 특징: 앞의 수식어와 반드시 띄여쓴다\n   - 예: 것, 김, 나름, 나위, 노릇, 듯, 만, 대로, 데, 등, 물, 별, 번, 바, 리, 만치, 만큼, 물력\n\n2. 일반 명사\n   - 정의: 홀로 자립적으로 쓰일 수 있는 명사\n   - 특징: 의미적 통합성에 따라 붙여쓰거나 띄여쓴다\n   - 예: 점버섯 (붙여쓰기), 붉은 꽃 (띄여쓰기)\n\n구분 방법:\n- 불완전명사는 반드시 수식어가 필요함\n- 일반 명사는 독립적으로 사용 가능함\n\n례:\n올바름:\n- 좋은 것 (불완전명사, 띄여쓰기)\n- 점버섯 (일반명사 결합, 붙여쓰기)\n- 붉은 꽃 (일반명사 수식, 띄여쓰기)\n\n그릇됨:\n- 좋은것 (불완전명사를 붙여씀)\n- 점 버섯 (일반명사 결합을 분리)\n- 붉은꽃 (일반 수식을 붙여씀)\n\n설명: 불완전명사는 항상 띄여쓰고, 일반 명사는 의미적 통합성에 따라 결정한다.",
    "input": "",
    "metadata": {
      "category": "spacing",
      "type": "incomplete_noun_vs_noun",
      "has_examples": true,
      "enhanced": true,
      "source": "user_added"
    }
  ...
  {
    "instruction": "조선어에서 많이 쓰이는 고유어불완전명사들의 띄여쓰기 규칙을 설명하라.",
    "output": "고유어불완전명사는 앞의 단어와 띄여써야 한다.\n\n고유어불완전명사 목록 및 예시:\n\nㄱ\n- 것: 좋은 것으로 고르시오.\n- 개: 제도 개나 쓰던 놈.\n- 김: 시작한 김에 일을 끝내다.\n\nㄴ\n- 나름: 잘 먹고 못 먹고는 사람 나름이다.\n- 나위: 말할 나위가 없다.\n- 나절: 점심 먹을 나절이라 장사군과 장군들로 붐볐다.\n- 녘: 해가 뜰 녘에 집을 떠났다.\n- 노릇: 주인 노릇을 잘하시오.\n\nㄷ\n- 듯: 갈 듯도 하다.\n- 등: 사과, 배, 복숭아 등 과일.\n- 대로: 바람 부는 대로 항라.\n- 데: 노래 부르는 데 소절이 있다.\n\nㄹ\n- 리: 그가 늦을 리 없다.\n\nㅁ\n- 만: 노래를 부를 만하다.\n- 만치: 요구하는 만치 일을 맡기다.\n- 만큼: 볼 만큼 보았다.\n- 물력: 식사를 끝낼 물력에 물이 상당히 빠져있었다.\n- 물: 한 물밖에 안 입은 옷, 세 물째 딴 수박.\n\nㅂ\n- 바: 느낀 바를 얘기하다.\n- 번: 놓칠 번하다.\n- 별: 4촌 별이 되는 사람.\n\nㅅ\n- 분: 저기 오시는 분이 누구냐?\n- 사: 붐을 사한 사과.\n- 상: 이 근방에 있을 상 싶다.\n- 성: 될 성 싶다.\n- 손: 갈 손 치더라도, 간다 손 치더라도.\n- 수: 갈 수가 없다.\n\nㅇ\n- 앙: 일을 할 양으로.\n- 이: 모르는 이, 아는 이.\n- 적: 사랑의 손길을 가슴 뜨겁게 느껴 본 적이 없다.\n\nㅈ\n- 조: 장난하는 조로 묻다.\n- 줄: 올 줄 알았다.\n- 즈음: 뼈날 즈음에 그가 왔다.\n- 즘: 갈 즘.\n- 지: 간 지가 오래다.\n- 짓: 못된 짓을 하다.\n\nㅊ\n- 척: 모르는 척하지 말라.\n- 치: 한달 치 식량.\n- 채: 산 채로 잡은 짐승.\n- 체: 모르는 체하다.\n\nㄲ\n- 깐: 말하는 깐을 보다.\n\nㄲ\n- 껏: 있는 껏 가져오너라.\n\nㄷ\n- 따위: 너 따위는 셈도 없다.\n- 때문: 그 때문이 아니다.\n\nㄸ\n- 또래: 같은 나이 또래.\n\nㅃ\n- 뿐: 눈물만 흘릴 뿐이다.\n\nㅋ\n- 켠: 우리 켠 사람.\n\nㅌ\n- 탁: 될 탁이 없다.\n- 터: 과학자가 될 터이다.\n- 턱: 그럴 턱이 있나요?\n- 통: 뼈들어대는 통에 자지 못했다.\n\nㅍ\n- 품: 말하는 품이 서로 다르다.\n\nㅊ\n- 쪽: 바다 쪽에서 부는 바람.\n- 쯤: 한달 쯤 걸린다.\n\nㅎ\n- 해: 이 물건은 내 해이다.\n\n례:\n올바름:\n- 좋은 것으로 고르시오.\n- 시작한 김에 일을 끝내다.\n- 사람 나름이다.\n- 말할 나위가 없다.\n- 주인 노릇을 잘하시오.\n- 갈 듯도 하다.\n- 사과, 배 등 과일.\n- 늦을 리 없다.\n- 부를 만하다.\n- 볼 만큼 보았다.\n- 느낀 바를 얘기하다.\n- 저기 오시는 분이 누구냐?\n- 모르는 이.\n- 올 줄 알았다.\n- 모르는 척하지 말라.\n- 한달 치 식량.\n- 될 터이다.\n- 말하는 품이 서로 다르다.\n- 이 물건은 내 해이다.\n- 말하는 깐을 보다.\n- 있는 껏 가져오너라.\n- 너 따위는 셈도 없다.\n- 같은 나이 또래.\n- 그 때문이 아니다.\n- 눈물만 흘릴 뿐이다.\n- 바다 쪽에서 부는 바람.\n- 한달 쯤 걸린다.\n\n그릇됨:\n- 좋은것으로 고르시오.\n- 시작한김에 일을 끝내다.\n- 사람나름이다.\n- 말할나위가 없다.\n- 주인노릇을 잘하시오.\n- 갈듯도 하다.\n- 사과, 배등 과일.\n- 늦을리 없다.\n- 부를만하다.\n- 볼만큼 보았다.\n- 느낀바를 얘기하다.\n- 저기 오시는분이 누구냐?\n- 모르는이.\n- 올줄 알았다.\n- 모르는척하지 말라.\n- 한달치 식량.\n- 될터이다.\n- 말하는품이 서로 다르다.\n- 이 물건은 내해이다.\n- 말하는깐을 보다.\n- 있는껏 가져오너라.\n- 너따위는 셈도 없다.\n- 같은 나이또래.\n- 그때문이 아니다.\n- 눈물만 흘릴 뿐이다.\n- 바다쪽에서 부는 바람.\n- 한달쯤 걸린다.\n\n설명: 고유어불완전명사는 홀로 자립적으로 쓰일 수 없는 명사로, 앞의 수식어와 반드시 띄여쓴다.",
    "input": "",
    "metadata": {
      "category": "spacing",
      "type": "native_incomplete_nouns",
      "has_examples": true,
      "enhanced": true,
      "source": "user_added"
    }
  ...
  {
    "instruction": "조선어에서 쓰이는 한자어불완전명사들의 띄여쓰기 규칙을 설명하라.",
    "output": "한자어불완전명사는 앞의 단어와 띄여써야 한다.\n\n한자어불완전명사 목록 및 예시:\n\nㄱ\n- 간(間): 형제 간에, 있든 없든 간에\n- 경(頃): 5월경, 두시경, 1시 10분경\n- 급(級): 고위급, 부장급, 60킬로급\n- 계(系): 은하계\n- 과(科): 산부인과\n\nㄴ\n- 내(內): 직장 내 위생사업, 학교 내에서, 부내 내에서, 회사 내에서\n\nㄷ\n- 당(當): 단위당 수확고, 헥타르당 수확고\n\nㄹ\n- 래(來): 몇십년래 오는 더위, 5년래\n\nㅁ\n- 말(末): 2월말 생산실적, 20세기말\n\nㅂ\n- 발(發): 연길발 북경행 렬차\n- 별(別): 개인별 계획, 학급별, 부문별 사전, 품종별\n- 부(附): 3일부\n\n례:\n올바름:\n- 형제 간에 화목하다.\n- 있든 없든 간에\n- 5월경에 완공될 예정이다.\n- 두시경에 도착하다.\n- 고위급 회의\n- 부장급 간부\n- 60킬로급 선수\n- 은하계의 별들\n- 산부인과 진료\n- 직장 내 위생사업\n- 학교 내에서\n- 회사 내에서\n- 단위당 수확고\n- 헥타르당 수확고\n- 몇십년래 오는 더위\n- 5년래의 변화\n- 2월말 생산실적\n- 20세기말에\n- 연길발 북경행 렬차\n- 개인별 계획\n- 학급별로 나누다\n- 부문별 사전\n- 품종별로 분류하다\n- 3일부로 결정하다\n\n그릇됨:\n- 형제간에 화목하다.\n- 있든없든간에\n- 5월경에 완공될 예정이다.\n- 두시경에 도착하다.\n- 고위급회의\n- 부장급간부\n- 60킬로급선수\n- 은하계의별들\n- 산부인과진료\n- 직장내 위생사업\n- 학교내에서\n- 회사내에서\n- 단위당수확고\n- 헥타르당수확고\n- 몇십년래오는 더위\n- 5년래의변화\n- 2월말생산실적\n- 20세기말에\n- 연길발북경행 렬차\n- 개인별계획\n- 학급별로나누다\n- 부문별사전\n- 품종별로분류하다\n- 3일부로결정하다\n\n설명: 한자어불완전명사는 고유어불완전명사와 마찬가지로 홀로 자립적으로 쓰일 수 없는 명사로, 앞의 수식어와 반드시 띄여쓴다.",
    "input": "",
    "metadata": {
      "category": "spacing",
      "type": "chinese_incomplete_nouns",
      "has_examples": true,
      "enhanced": true,
      "source": "user_added"
    }
  ...
  {
    "instruction": "고유어불완전명사와 한자어불완전명사의 공통점과 차이점을 설명하라.",
    "output": "고유어불완전명사와 한자어불완전명사의 비교:\n\n공통점:\n1. 둘 다 홀로 자립적으로 쓰일 수 없는 불완전명사\n2. 앞의 수식어와 반드시 띄여쓴다\n3. 명사의 하위분류로서 하나의 단어로 인식됨\n\n차이점:\n1. 어원적 차이\n   - 고유어불완전명사: 조선어 고유의 어휘\n     예: 것, 김, 나름, 듯, 만, 바 등\n   - 한자어불완전명사: 한자어에서 유래한 어휘\n     예: 간(間), 경(頃), 급(級), 내(內), 당(當) 등\n\n2. 형태적 차이\n   - 고유어: 한글로만 표기\n   - 한자어: 한글 표기 뒤에 한자를 병기하는 경우가 많음\n\n3. 용법적 차이\n   - 고유어: 일상적이고 구어체적인 표현에 많이 사용\n   - 한자어: 문어처이거나 전문적인 표현에 많이 사용\n\n례:\n올바름:\n- 고유어: 좋은 것, 시작한 김에, 사람 나름, 갈 듯, 부를 만\n- 한자어: 형제 간, 5월경, 고위급, 직장 내, 단위당\n\n그릇됨:\n- 고유어: 좋은것, 시작한김에, 사람나름, 갈듯, 부를만\n- 한자어: 형제간, 5월경, 고위급, 직장내, 단위당\n\n설명: 어원에 관계없이 모든 불완전명사는 앞의 수식어와 띄여쓴다.",
    "input": "",
    "metadata": {
      "category": "spacing",
      "type": "incomplete_nouns_comparison",
      "has_examples": true,
      "enhanced": true,
      "source": "user_added"
    }
