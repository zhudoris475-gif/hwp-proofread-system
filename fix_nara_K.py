...
K_3RD = r"C:\Users\doris\Desktop\xwechat_files\WORD\K 1694-1786--93--20240920_교정본_상세로그_20260418_재실행_작업본_최근규칙_작업본_20260418_3차.hwp"
...
def main():
    shutil.copy2(K_3RD, K_MAIN)
    print(f"3차 → 메인 파일 복사 완료")
